...
class Lof_AdminPayment_Helper_Data extends Mage_Core_Helper_Abstract
{
	const XML_PATH_GENERAL_ENABLED = 'lof_adminpayment/general/enabled';
	const XML_PATH_GENERAL_CALC_INC_SHIP = 'payment/lof_adminpayment/calc_including_shipping';
	const XML_PATH_STANDARD_FEE_LOCAL = 'payment/lof_adminpayment/standard_fixed_fee_local';
	const XML_PATH_STANDARD_FEE_FOREIGN = 'payment/lof_adminpayment/standard_fixed_fee_foreign';
	const XML_PATH_PRICE_INCLUDING_TAXES = 'payment/lof_adminpayment/price_including_taxes';
	const XML_PATH_SHIPPING_COUNTRY_ID = 'shipping/origin/country_id';
	const XML_PATH_DESCRIPTION = 'payment/lof_adminpayment/cod_description';

	const Lof_COD_LOCAL = 'local';
	const Lof_COD_FOREIGN = 'foreign';

	const XML_PATH_COD_TAX_CLASS = 'tax/classes/lof_adminpayment_taxclass';
	const XML_PATH_COD_INCL_TAX = 'tax/calculation/lof_adminpayment_includes_tax';
	const XML_PATH_COD_DISPLAY_MODE = 'tax/display/lof_adminpayment';
	const XML_PATH_COD_TOTALROW_DISPLAY_MODE = 'tax/display/lof_adminpayment_total';
	...
	public function getZoneType() {
		...
		return $_shippingAddress->getCountryId() == $this->getShippingCountryId($_storeId) ? self::Lof_COD_LOCAL : self::Lof_COD_FOREIGN;
	}

	public function getStandardFixedFee($storeId = null)
	{
		if ($this->getZoneType() == self::Lof_COD_LOCAL)
