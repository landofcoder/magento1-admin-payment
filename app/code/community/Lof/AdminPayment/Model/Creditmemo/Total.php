...
class Lof_AdminPayment_Model_Creditmemo_Total extends Mage_Sales_Model_Order_Creditmemo_Total_Abstract
{
	public function collect(Mage_Sales_Model_Order_Creditmemo $invoice)
	{
		...
		$invoice->setMspAdminpayment($amount);
		$invoice->setMspBaseAdminpayment($baseAmount);
